          ...
          '/zh/guides/': [
            {
              ...
              items: [
                ...
                { text: '持久化 Bash', link: '/zh/guides/stateful-bash' },
                { text: 'SSH 远程会话', link: '/zh/guides/ssh-sessions' },
          ...
          '/en/guides/': [
            {
              ...
              items: [
                ...
                { text: 'Stateful Bash', link: '/en/guides/stateful-bash' },
                { text: 'SSH Remote Sessions', link: '/en/guides/ssh-sessions' },
