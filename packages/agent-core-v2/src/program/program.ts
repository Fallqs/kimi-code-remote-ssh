...
export class Program {
  ...
  private createGeneration(): ProgramGeneration {
    ...
    try {
      ...
      const userAgentProfiles = own(new UserAgentProfileLoaderService(this.dependencies.bootstrap, runtime.fs!, this.dependencies.log, this.dependencies.builtinAgentProfiles, this.context, runtime.environment, this.dependencies.agentProfiles));
      ...
      const explicitAgentProfiles = own(new ExplicitAgentProfileLoaderService(this.context, this.dependencies.bootstrap, runtime.environment, runtime.fs!, this.dependencies.log, userAgentProfiles, this.dependencies.agentProfiles));
      const extraAgentProfiles = own(new ExtraAgentProfileLoaderService(this.dependencies.config, this.context, this.dependencies.bootstrap, runtime.environment, runtime.fs!, this.dependencies.log, userAgentProfiles, this.dependencies.agentProfiles));
